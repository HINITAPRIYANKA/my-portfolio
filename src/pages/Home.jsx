...
function Home() {
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      @media (max-width: 768px) {
        ...
        h2 { font-size: 20px !important; width: 90vw !important; }
        p { font-size: 16px !important; max-width: 90% !important; }
        .hero { padding: 0 10px !important; }
      }
    `;
  ...
  const pageStyle = {
    ...
    textAlign: "center",
    overflow: "hidden",
    background: "linear-gradient(to right, #eaf6ff, #f7fbff)",
    padding: "0 20px",
  ...
  const particlesStyle = {
    ...
    height: "100%",
    zIndex: 0,
    backgroundImage: "radial-gradient(#cce6ff 1.5px, transparent 1.5px)",
  ...
  const typingStyle = { 
    ...
    width: "min(90vw, 48ch)", // responsive width
